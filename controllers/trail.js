...
//     var lat = 47.685058;
//     var lon = -122.299247;
//     var trailUrl = 'https://www.hikingproject.com/data/get-trails?lat=' + lat + '&lon=' + lon + '&maxDistance=50&maxResults=5&key=' + process.env.HIKING_PROJECT_API;
//     // Use request to call the API
//     axios.get(trailUrl).then( function(apiResponse) {
//         let trails = apiResponse.data;
//         // console.log(trails)
